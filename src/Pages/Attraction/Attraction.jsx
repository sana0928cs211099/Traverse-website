...
import DestiCard from '../../Components/Attraction/DestiCard';
    ...
    <div className=" ">
      ...
      <div className="relative mb-40">
        <video className=" inset-0 w-full h-[70vh] object-cover" autoPlay muted loop>
          <source src="https://www.pexels.com/download/video/3126576/" type="video/mp4" />
        </video>
        ...
        <div className="absolute w-[60vw] h-auto bottom-0 left-1/2 transform -translate-x-1/2 translate-y-1/2 bg-white p-6 rounded-xl shadow-lg">
          <h2 className="text-xl font-bold mb-4">Plan Your Dream Attractions With Us</h2>
